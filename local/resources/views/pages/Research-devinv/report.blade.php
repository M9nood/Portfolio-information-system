       ...
       <div class="card">
        ...
        <div class="row">
          ...
          <div style="text-align:center;margin-top:15px;">
            <?php
              $printURL = url('research-devinv/print')."?startTime=".$_GET['startTime']."&endTime=".$_GET['endTime'];
            ...
            <a  class="btn btn-viewdt"  data-target="#viewAllfileModal" data-toggle="modal" data-token="{{ csrf_token() }}" data-datest="{{$_GET['startTime']}}" data-dateend="{{$_GET['endTime']}}" data-path="{{url('file/'.Auth::user()->id.'/research-devinv/all')}}" ><i class="fa fa-file"></i> พิมพ์เอกสาร</a></td>
          </div>
         </div> 
        </div> 
        @endif
