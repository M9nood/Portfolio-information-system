    ...
    <div class='col-md-12'>
       <div class="card">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="{{url('fac-report')}}" ><i class="fa fa-file-text" aria-hidden="true"></i> รายงานคณะฯ</a></li>
          <li role="presentation" ><a href="{{url('dep-report')}}"  ><i class="fa fa-file-text" aria-hidden="true"></i> รายงานภาควิชา</a></li>
        </ul>
        
        <div class="panel panel-default" style="margin-top:30px">
        <!-- Default panel contents -->
        <div class="panel-heading"><h5 style="font-family: Mitr">รายงานผลงาน คณะ{{f::getFacultyName(Auth::user()->department_id)}}</h5></div>
        <div class="panel-body">
          <div class="col-md-12 ">
            {{ Form::open(['url' => 'fac-report', 'method' => 'get']) }}
            <table border="0" width="60%" align="center" >
                <tr style="padding-bottom:10px">
                  <td  width="25%"  style="text-align:right;padding-right:15px" ><b>เลือกประเภทผลงาน</b></td>
      ...
      @if(isset($html))
      <div class="paper-heading">รายงาน{{$tsk->name}} &nbsp&nbsp&nbsp อัพเดตวันที่ : {{f::dateThaiFull(date("Y-m-d"))}}</div>
      <div class="card">
      <div class="row">
        {!!$html!!}
      </div>
