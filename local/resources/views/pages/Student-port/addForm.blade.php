     ...
     <div class='col-md-12'>
       <div class="card">
        ...
        <div class="panel panel-info" style="margin-top:30px">
            ...
            <div class="panel-heading title-content"><h5 >แบบฟอร์มเพิ่มรายการผลงานนักศึกษา</h5></div>
            <div class="panel-body">
              <div  class="alert alert-danger print-error-msg" style="margin:15px 50px;display:none">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <ul></ul>
                </div>
                {{ Form::open(['url' => '/std-portfolio/add/save', 'method' => 'post','enctype'=>'multipart/form-data','id' =>'uploadform','class'=>'form-horizontal']) }}
                  <div class="col-md-12 dropdown" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <textarea class="form-control" rows="3" name="stp_desc" id="stp_desc"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
