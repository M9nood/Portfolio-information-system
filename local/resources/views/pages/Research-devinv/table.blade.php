          ...
          <div role="tabpanel" class="tab-pane active" id="home">
            <div class="">
              <div class="title-content" >
                <h5>รายการผลงานวิจัยและพัฒนาสิ่งประดิษฐ์ของ : {{Auth::user()->name." ".Auth::user()->lastname}}</h5>
              </div>
              <div class="pull-right">
                <a class="btn btn-primary btn-flat" data-toggle="tooltip" title="เพิ่ม" href="{{url('/research-devinv/add')}}"><i class="fa fa-lg fa-plus"></i></a><a class="btn btn-info btn-flat" data-toggle="tooltip" title="รีเฟรช" onClick="refresh()"><i class="fa fa-lg fa-refresh"></i></a>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                    ...
                    <table class="table table-hover table-bordered " id="sampleTable" >
                      <thead>
                        <tr style="background-color:#8cb3d9">
                          ...
                          <th width="90">วันที่ดำเนินการ</th>
                          <th width="180">ชื่องาน</th>
                          <th width="100">ตำแหน่ง</th>
                          <th width="70">ประเภทงาน</th>
                      ...
                      <tbody>
                          @foreach ($datas as $key=> $data)
                            <tr>
                              ...
                              <td>{{val::getRSDCategory($data->rsd_category)}}</td>
                              <td align="center" >
                                  <a class="btn btn-info btn-xs" style="padding:5px" title="รายละเอียด"  data-toggle="modal" data-target="#viewModal"  data-id="{{$data->rsd_id}}"><i class="fa fa-lg fa-info-circle"></i></a>
                                  <a class="btn btn-warning btn-xs" style="padding:5px" title="แก้ไข"  href="{{url('/research-devinv/edit/'.$data->rsd_id)}}" @if(Auth::user()->id != $data->personnel_id) disabled @endif><i class="fa fa-lg fa-edit"></i></a>
                                  <a class="btn btn-danger btn-xs" style="padding:5px" href="#" title="ลบ" data-toggle="modal" data-target="#confirmDeleteModal" data-name="{{$data->rsd_name}}" data-id="{{$data->rsd_id}}"><i class="fa fa-lg fa-trash"></i></a>
                              </td>
                            </tr>
                          @endforeach 
                      </tbody>
