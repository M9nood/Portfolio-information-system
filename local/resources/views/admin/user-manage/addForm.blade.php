     ...
     <div class='col-md-12'>
       <div class="card">
        ...
        <div class="panel panel-success" style="margin-top:30px">
          ...
          <div class="panel-heading title-content"><h5>แบบฟอร์มเพิ่มข้อมูลผู้ใช้งาน</h5></div>
          <div class="panel-body">
            <div  class="alert alert-danger print-error-msg" style="margin:15px 50px;display:none">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               <ul></ul>
            </div>
           {{ Form::open(['url' => 'admin/user-manage/add', 'method' => 'post','enctype'=>'multipart/form-data','id' =>'uploadform','class'=>'form-horizontal']) }}
             <div class="row">
              <div class="col-md-12"> 
                  ...
                  <div class="col-sm-4" style="padding-left:0px">
                    <select class="form-control drop-box" style="margin-top:0px"  name="ttname" id="chkttname">
                          @foreach($ttName as $key => $ttName)
                            <option value="{{$key}}">{{$ttName}}</option>
                          @endforeach 
                    </select>
                 ...
                 <tr>
                  ...
                  <td><input type="text" name="lname" class="form-control input-sm" style="width:30%"></td>
                 </tr>
                 <tr>
                  <td  style="text-align:right">ชื่อย่อภาษาอังกฤษ</td>
                  <td>
                    <input type="text"  name="shortname"  class="form-control input-sm" style="width:15%" >
                  </td>
                 </tr>
                 <tr>
                  ...
                  <td>
                    <div class="form-inline">
                      <input type="email" id="email" name="email" class="form-control input-sm" style="width:30%">
                 ...
                 <tr>
                  ...
                  <td >
                    <select class="form-control drop-box"  name="department" id="department"  style="width:50%">
                 ...
                 <tr>
                  ...
                  <td>
                    <select class="form-control drop-box"  name="faculty" id="faculty" style="width:50%">
