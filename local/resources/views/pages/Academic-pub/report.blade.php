     ...
     <div class='col-md-12'>
       <div class="card">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" ><a href="{{url('/academic-pub')}}" ><i class="fa fa-lg fa-table" aria-hidden="true"></i>&nbsp ตารางงาน</a></li>
          <li role="presentation" class="active"><a href="{{url('/academic-pub/report')}}"  ><i class="fa fa-lg fa-file-text" aria-hidden="true"></i>&nbsp ดูรายงาน</a></li>
        </ul>
        <div class="panel panel-default" style="margin-top:30px">
          ...
          <div class="panel-body">
           <div class="col-md-12 ">
              {{ Form::open(['url' => 'academic-pub/report', 'method' => 'get']) }}
      ...
      @if(isset($_GET['startTime'])  )
          <div class="paper-heading">รายงานงานเผยแพร่ผลงานทางวิชาการ &nbsp&nbsp&nbsp อัพเดตวันที่ : {{f::dateThaiFull(date("Y-m-d"))}}</div>
            <div class="card">
               <div class="row">
                                ...
                                @if(($i+1) == $task->acp_task_type)
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top" style="line-height: 1;" > 
                                      ...
                                      @if($task->acp_user_role!==99)- {{val::ACPRole($task->acp_user_role)}} @endif
                                    </td>
                ...
                <div style="text-align:center;margin-top:15px;">
                  <?php
                    $printURL = url('academic-pub/print')."?startTime=".$_GET['startTime']."&endTime=".$_GET['endTime'];
                  ...
                  <a  class="btn btn-viewdt"  data-target="#viewAllfileModal" data-toggle="modal" data-token="{{ csrf_token() }}" data-datest="{{$_GET['startTime']}}" data-dateend="{{$_GET['endTime']}}" data-path="{{url('file/'.Auth::user()->id.'/academic-pub/all')}}" ><i class="fa fa-file"></i> พิมพ์เอกสาร</a></td>
                </div>
              </div>
            </div>  
        @endif 
