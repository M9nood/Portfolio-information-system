     ...
     <div class='col-md-12'>
       <div class="card">
        ...
        <div class="panel panel-success" style="margin-top:30px">
          ...
          <div class="panel-heading title-content"><h5>แบบฟอร์มเพิ่มข้อมูลคณะ</h5></div>
          <div class="panel-body">
            <div  class="alert alert-danger print-error-msg" style="margin:15px 50px;display:none">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               <ul></ul>
            </div>
           {{ Form::open(['url' => 'admin/fac-manage/add', 'method' => 'post','enctype'=>'multipart/form-data','id' =>'uploadform','class'=>'form-horizontal']) }}
             <div class="row">
              <div class="table-responsive">
                 ...
                 <!--<td  style="text-align:right;width:130px" valign="middle">รหัสคณะ</td>
                  <td width="130">
                    <input type="text"  name="fac_id" class="form-control input-sm" >
                  </td> -->
                  <td  style="text-align:center;width:60px">ชื่อคณะ</td>
                  <td width="300">
                    <input type="text"  name="fac_name" class="form-control input-sm" >
                  </td>
                 </tr>
